...
read -e var
echo ""
echo blastx in progress...
blastx -db /media/bioinf/Data/Blastdb/nr/nr -num_alignments 1 -num_threads 16 -outfmt 11 -query /home/bioinf/Desktop/local_blast/raw_data/$varname > /home/bioinf/Desktop/local_blast/results/${var}.asn
