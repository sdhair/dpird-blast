...
read -e var
echo How many alignments per read do you want to return?
read -e var1
echo What percent identity cut-off do you want to allow - do not include % sign?
read -e varperc
echo ""
echo blastn in progress...
blastn -db /media/bioinf/Data/Blastdb/nt/nt -num_alignments $var1 -num_threads 16 -outfmt 11 -perc_identity $varperc -task blastn -query /home/bioinf/Desktop/local_blast/raw_data/$varname > /home/bioinf/Desktop/local_blast/results/${var}.asn
